...
export default function BrondolAdd({navigation, route}) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <MyHeader
        title="Tambah Transaksi BRONDOL"
            ...
            <View style={styles.flexLeft}>
              <MyPicker
                ...
                data={[
                  ...
                  ...new Map(
                    DATA_UTAMA.filter(
                      e => e.divisi === kirim.divisi && e.tipe === 'BRONDOL',
                    ).map(item => [
                      item.mandor,
